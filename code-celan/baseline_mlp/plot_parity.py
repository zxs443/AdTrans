"""Parity plots for MLP baseline (caption adapted from Adtrans Transformer plots)."""
...
from config import INPUT_CONFIG, format_input_config_summary, input_config_tag
...
def build_baseline_parity_model_info(encoder_type: str, decoder_type: str) -> str:
    """Top-left parity caption for flattened MLP (not Transformer encoder–decoder)."""
    features = ["formula"]
